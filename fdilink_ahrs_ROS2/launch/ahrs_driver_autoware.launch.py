...
def generate_launch_description():
    ...
    ahrs_driver = Node(
        ...
        parameters=[config_dir, {'use_sim_time': use_sim_time}],  # 加载配置文件
        output="screen"
    )

    launch_description =LaunchDescription()
    launch_description.add_action(DeclareLaunchArgument('use_sim_time', default_value='False'))
