...
被 `planning_simulator.launch.xml` 通过 `sensor_model:=wtb_sensor_kit` 自动调用。
也可独立启动子模块：
- `ros2 launch wtb_sensor_kit_launch lidar.launch.xml`
- `ros2 launch wtb_sensor_kit_launch imu.launch.xml`
- `ros2 launch wtb_sensor_kit_launch sensing.launch.xml`
